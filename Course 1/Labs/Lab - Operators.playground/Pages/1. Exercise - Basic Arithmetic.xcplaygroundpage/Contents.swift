...
//It is different because a Double can represent decimals, making division more accurate.
/*:
...
//This is how I would write code to determine if a number is even or odd.

oddOrEven(numberToBeDetermined: 60)

func oddOrEven(numberToBeDetermined: Int) {
    let remainder: Int = numberToBeDetermined % 2
    
    remainder > 0 ? print("Odd") : print("Even")
}
