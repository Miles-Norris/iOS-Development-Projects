...
let heartRate3D: Double = 87
let addedHRD = heartRate1D + heartRate2D + heartRate3D
let averageHRD = addedHRD / 3
print(averageHRD)
//Like before it changes because it can now take decimals into account to get a more accurate answer.
...
// How I would display the percent completed.
print("You are %\(percentOfGoal) done!")
