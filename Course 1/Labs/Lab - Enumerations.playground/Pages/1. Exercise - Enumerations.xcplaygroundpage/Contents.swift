...
func getFortune(cardSuit: Suit) {
    ...
    case .clubs:
        print("Misfortune will befall you.")
    case .spades:
        print("You will soon make a great discovery.")
    case .diamonds:
        print("You will stummble upon great wealth.")
    }
}
...
let card2 = Card(suit: .hearts, value: .eight)
