 ...
 */
var dayCountInMonth: [String: Int] = ["January": 31, "February": 28, "March": 31]
print(dayCountInMonth)

//:  Using subscripting syntax to add April to the collection with a value of 30. Print the dictionary.
dayCountInMonth["April"] = 30
print(dayCountInMonth)

//:  It's a leap year! Update the number of days in February to 29 using the `updateValue(_:, forKey:)` method. Print the dictionary.
dayCountInMonth.updateValue(29, forKey: "February")
print(dayCountInMonth)
//:  Use if-let syntax to retrieve the number of days under "January." If the value is there, print "January has 31 days", where 31 is the value retrieved from the dictionary.
if let daysInJanuary = dayCountInMonth["January"] {
    print("January has \(daysInJanuary) days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
var shapesArray = ["Square", "Triangle", "Rectangle"]
var colorsArray = ["Blue", "Green", "Yellow"]
...
if let lastColor = shapesAndColors["Colors"] {
    print(lastColor[2])
}
/*:
