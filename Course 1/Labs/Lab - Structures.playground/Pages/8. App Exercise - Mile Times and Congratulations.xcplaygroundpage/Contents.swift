...
var runningWorkout1 = RunningWorkout(distance: 6048, time: 57, elevation: 698)

print(runningWorkout1.averageMileTime)
/*:
...
var stepsForToday = Steps(steps: 9999, goal: 10000)
stepsForToday.takeStep()
/*:
