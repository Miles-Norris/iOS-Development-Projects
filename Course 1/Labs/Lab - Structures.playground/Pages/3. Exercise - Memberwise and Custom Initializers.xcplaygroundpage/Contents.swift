...
print(Book(title: "Yumi and the nightmare painter", author: "Brandon Sanderson", pages: "478", price: "59.99"))
/*:
...
Laptop(yearPurchased: 2009)

Laptop(yearPurchased: 2021)
/*:
...
var myHeight = Height(heightInInches: 73)
