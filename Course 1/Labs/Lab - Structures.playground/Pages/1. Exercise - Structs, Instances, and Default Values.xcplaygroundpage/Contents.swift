...
favoriteBook.title = "The Stormlight Archives"
favoriteBook.author = "Branden Sanderson"
favoriteBook.pages = 1158
favoriteBook.price = 39.99

print(favoriteBook)
print("My favorite book is \(favoriteBook.title) by ...")
/*:
