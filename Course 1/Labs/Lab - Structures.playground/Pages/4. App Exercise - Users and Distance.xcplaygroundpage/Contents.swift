...
var miles = User(name: "Miles", age: 17, height: 73, weight: 175, activityLevel: 6)

print(miles.name, miles.age, miles.height, miles.weight, miles.activityLevel)
/*:
...
let mile = Distance(distanceInMeters: 1600)
print(mile.distanceInFeet)
//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
let kilometer = Distance(distanceInMeters: 1000)
print(kilometer.distanceInFeet)
/*:
